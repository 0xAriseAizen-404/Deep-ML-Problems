...
First, compute the transformation using the first weight matrix:
...
Next, apply the second weight matrix:
...
Add the original input through the shortcut connection:
...
Therefore, the output is `[1.5, 3.0]`.
